class SuratMasukController < ApplicationController
  ...
  private
    ...
    def surat_masuk_params
      params.require(:surat_masuk).permit(:nomor_surat, :tanggal_surat, :lampiran, :diterima_tgl, :no_agenda, :dari, :perihal, status_surat_masuk_ids:[], sifat_surat_masuk_ids:[], derajat_pengaman_ids:[])
    end
end
